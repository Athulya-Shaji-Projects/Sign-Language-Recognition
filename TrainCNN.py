...
train_path = r'C:\Users\DELL\Downloads\gesture\train'
test_path = r'C:\Users\DELL\Downloads\gesture\test'
...
#model.compile(optimizer=adam_v2(learning_rate=0.001), loss='categorical_crossentropy', metrics=['accuracy'])
